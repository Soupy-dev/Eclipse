...
struct SettingsView: View {
    ...
    private static let baseSettingsSearchEntries: [SettingsSearchEntry] = {
        var entries: [SettingsSearchEntry] = [
            ...
            .init(id: "subtitle-delay", title: "MPV Subtitle Delay", location: "Media Player > MPV Player > Subtitle Defaults", icon: "captions.bubble", color: .cyan, keywords: ["MPV", "timing", "latency", "offset"], action: .destination(.playerTarget(.subtitleDelay))),
            ...
            .init(id: "dolby-vision", title: "Dolby Vision", location: "Media Player > MPV Rendering", icon: "sun.max.fill", color: .cyan, keywords: ["DV", "metadata", "HDR", "color"], action: .destination(.playerTarget(.dolbyVision))),
            .init(id: "dolby-atmos", title: "Dolby Atmos", location: "Media Player > MPV Rendering", icon: "hifispeaker.2", color: .cyan, keywords: ["DA", "spatial audio", "EAC3", "Dolby Digital Plus", "surround"], action: .destination(.playerTarget(.dolbyAtmos))),
            ...
            .init(id: "autoplay-next-episode", title: "Autoplay Next Episode", location: "Media Player > Next Episode", icon: "play.fill", color: .yellow, keywords: ["automatic playback", "auto play", "next"], action: .destination(.playerTarget(.nextEpisode))),
            ...
            .init(id: "appearance-animation-frame-rate", title: "Animation Frame Rate", location: "Appearance > Motion & Startup", icon: "speedometer", color: .purple, keywords: ["20 FPS", "30 FPS", "60 FPS", "120 FPS", "smooth", "battery", "background motion"], action: .destination(.appearanceTarget(.animationFrameRate))),
            .init(id: "image-data-saver", title: "Image Data Saver", location: "Appearance", icon: "photo", color: .purple, keywords: ["lower quality", "images", "data saver", "bandwidth"], action: .destination(.appearanceTarget(.dataSaver))),
            ...
            .init(id: "remember-playback-choice", title: "Remember Last Choice per Show", location: "Services > Auto Mode", icon: "clock.arrow.circlepath", color: .purple, keywords: ["last source", "last stream", "last search result"], action: .destination(.servicesTarget(.autoMode))),
