...
struct PlayerSubtitleAppearance {
    ...
    static func overridesASSStyles(
        ...
        !foregroundColor.isEqual(UIColor.white)
            || !strokeColor.isEqual(UIColor.black)
    ...
    static func mpvColor(_ color: UIColor) -> String {
    ...
    private static func color(defaults: UserDefaults, key: String, fallback: UIColor) -> UIColor {
    ...
    private static func argb(_ color: UIColor) -> [CGFloat] {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
...
private final class TVAVPlayerExternalSubtitleController {
    ...
    init(
        ...
        subtitleSourceKind = request.launchContext?.sourceKind
        subtitleSourceID = request.launchContext?.sourceId
    ...
    private func configureOverlay(in controller: AVPlayerViewController) {
        ...
        label.font = .systemFont(
            ofSize: PlayerSubtitleAppearance().fontSize,
            weight: .semibold
        )
    ...
    private static func makeCandidates(from request: PlaybackRequest) -> [Candidate] {
        ...
        return request.subtitles.enumerated().compactMap { index, rawValue in
