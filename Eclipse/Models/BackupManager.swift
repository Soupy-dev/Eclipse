...
struct BackupData: Codable {
    ...
    static func nuvioStateForExperimentalCloudSync(
        ...
        PluginCloudConfiguration.nuvioStateForExperimentalCloudSync(state)
    }

    static func nuvioMetadataForMediaState(
        persistedValue: Any?
    ) -> Data? {
        PluginCloudConfiguration.nuvioMetadataForMediaState(persistedValue: persistedValue)
    }
    ...
    static func nuvioRestorePlanForExperimentalCloudSync(
        ...
        PluginCloudConfiguration.nuvioRestorePlanForExperimentalCloudSync(incoming: incoming, current: current)
    }
    ...
    static func skyStreamSnapshotForExperimentalCloudSync(
        ...
        PluginCloudConfiguration.skyStreamSnapshotForExperimentalCloudSync(incoming, stripArchives: stripArchives)
    }
