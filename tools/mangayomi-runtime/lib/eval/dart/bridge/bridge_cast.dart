...
List<T>? asBridgedList<T>(Object? value, String property) {
  ...
  if (value is List) return value.map(unwrapBridgedValue).cast<T>().toList();
...
Object? unwrapBridgedValue(Object? value) {
  if (value is BridgedInstance) return value.nativeObject;
  if (value is InterpretedInstance && value.bridgedSuperObject != null) return value.bridgedSuperObject;
  return value;
}
