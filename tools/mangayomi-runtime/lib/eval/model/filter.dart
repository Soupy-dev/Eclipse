...
List<dynamic> filterValuesListToJson(List<dynamic> values) {
  return values.map((raw) {
    final e = raw is BridgedInstance ? raw.nativeObject : raw is InterpretedInstance ? raw.bridgedSuperObject : raw;
    if (e == null || e is String || e is num || e is bool || e is Map) return e;
